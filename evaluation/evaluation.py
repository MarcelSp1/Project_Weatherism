...
#Werte pro Stunde zählen, falls keine 30 vorhanden sind, wird dies im Results Ordner im Error log vermerkt.
def error_count():
...
#Durschnittswerte pro Stunde errechnen und diese zur weiterverarbeitung notieren.
